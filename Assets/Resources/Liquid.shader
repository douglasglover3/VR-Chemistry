        ...
        Pass
        {
            ...
            {          
                ...
                if (facing > 0) {
                    ...
                    finalResult = resultColored + foamColored;
                    finalResult.rgb += RimResult;
                } else {
                    // Back face (the top/inside)
                    finalResult = (_TopColor * (1-backfaceFoam) + backfaceFoamColor) * (foam + result);
                }
                finalResult.a = _Tint.a + foamColored.a;
                return finalResult;
            }
            ENDCG
        }
